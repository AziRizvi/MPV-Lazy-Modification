...
defaults = {
	...
	controls = 'menu,ST-stats_tog,play_pause,shuffle,loop-playlist,loop-file,fullscreen,hwdec,video,audio,subtitles,prev,items,next',
	controls_size = 35,
	controls_size_fullscreen = 45,
	controls_margin = 8,
	controls_spacing = 1,
